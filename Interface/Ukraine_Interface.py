...
class BrowserFrame(tk.Frame):
    ...
    def on_configure(self, event):
        if self.browser is None:
            ...
            ##################################################################################################################################################################
            self.browser = cef.CreateBrowserSync(cef_winfo, url=r'file:///G:/Mi%20unidad/Formaci%C3%B3n/Ingenier%C3%ADa%20de%20sistemas/Clases/Fundamentos%20de%20programaci%C3%B3n/Mapeador%20guerra%20en%20Ucrania/Mapas/archivos%20mapas/index.html')
...
class mapper(tk.Tk):
    def __init__(self):
        ...
        self.iconbitmap(fr'..\\Interface\\icon.ico')
